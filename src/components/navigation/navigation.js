        ...
        return (
            <div className='nav-wrapper'>
                <div className='branding'>
                    ...
                    <Link to="/"><SaturnoIcon fill='#92e678' width={45} height={45} /></Link>
                </div>
                ...
                <div className='user-basket-wrapper'>
                    ...
                    <CSSTransition nodeRef={nodeRefLogin} in={loginActive} timeout={200} classNames='fade' >
                        <div ref={nodeRefLogin}>{loginActive ? <Login messageRegister={messageRegister} handleIconLogin={handleIconLogin}/> : null}</div>
                    </CSSTransition>
                    ...
                    <CSSTransition nodeRef={nodeRefBasket} in={basketActive} timeout={200} classNames='fade' >
                        <div ref={nodeRefBasket}>{basketActive ? <Basket setMessageRegister={setMessageRegister} handleIconLogin={handleIconLogin} handleIconBasket={handleIconBasket}/> : null}</div>
                    </CSSTransition>
                    </div>   
            </div>
        );
