...
export default function FormAddress({ setSteps, user, setUser, address, setAddress, loggedUser }) {
    ...
    const puttingUser = (dataForm) => {
        axios.put(`https://planet-gamer-backend-a5283f6df278.herokuapp.com/user/${loggedUser.id}`, {
    ...
    const postingAddress = (dataForm) => {
        axios.post(`https://planet-gamer-backend-a5283f6df278.herokuapp.com/address/${loggedUser.id}`, {
    ...
    return (
        <div className='address-container'>
            ...
            <form className='form-address-wrapper' onSubmit={handleSubmit((data) => {
                setSteps(2);
                postingAddress(data);
                puttingUser(data);
            })}>
                ...
                <div className='one-column'>
                    ...
                    {errors.surnames && <div className='errorTag'>{errors.surnames.message}</div>}
                </div>
                ...
                <div className='one-column'>
                    ...
                    {errors.street && <div className='errorTag'>{errors.street.message}</div>}  
                </div>
                ...
                <div className='two-column'>
                    ...
                    {errors.second_line_street && <div className='errorTag'>{errors.second_line_street.message}</div>}
                    ...
                    {errors.phone_number && <div className='errorTag'>{errors.phone_number.message}</div>}
                </div>
                ...
                <div className='two-column'>
                    ...
                    {errors.postal_code && <div className='errorTag'>{errors.postal_code.message}</div>} 
